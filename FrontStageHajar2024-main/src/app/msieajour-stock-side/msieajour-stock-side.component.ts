...
@Component({
  selector: 'app-msieajour-stock-side',
  templateUrl: './msieajour-stock-side.component.html',
  styleUrls: ['./msieajour-stock-side.component.css']
})
export class MsieajourStockSideComponent implements OnInit {
