...
@Component({
  selector: 'app-add-commercial-sidebar',
  templateUrl: './add-commercial-sidebar.component.html',
  styleUrls: ['./add-commercial-sidebar.component.css']
})
export class AddCommercialSidebarComponent  {
