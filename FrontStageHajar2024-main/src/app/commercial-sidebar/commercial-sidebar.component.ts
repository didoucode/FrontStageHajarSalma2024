...
@Component({
  selector: 'app-commercial-sidebar',
  templateUrl: './commercial-sidebar.component.html',
  styleUrls: ['./commercial-sidebar.component.css']
})
export class CommercialSidebarComponent  {
