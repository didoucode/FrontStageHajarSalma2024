...
@Component({
  selector: 'app-validation-devis-side',
  templateUrl: './validation-devis-side.component.html',
  styleUrls: ['./validation-devis-side.component.css']
})
export class ValidationDevisSideComponent implements OnInit {
