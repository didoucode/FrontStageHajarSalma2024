...
@Component({
  selector: 'app-crud-prospect-comside',
  templateUrl: './crud-prospect-comside.component.html',
  styleUrls: ['./crud-prospect-comside.component.css']
})
export class CrudProspectComsideComponent  {
