...
@Component({
  selector: 'app-set-profil-assistant-sidebar',
  templateUrl: './set-profil-assistant-sidebar.component.html',
  styleUrls: ['./set-profil-assistant-sidebar.component.css']
})
export class SetProfilAssistantSidebarComponent  {
