...
@Component({
  selector: 'app-success-modal-edit-prospect',
  templateUrl: './success-modal-edit-prospect.component.html',
  styleUrls: ['./success-modal-edit-prospect.component.css']
})
export class SuccessModalEditProspectComponent  {
