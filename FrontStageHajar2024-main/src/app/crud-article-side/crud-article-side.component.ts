...
@Component({
  selector: 'app-crud-article-side',
  templateUrl: './crud-article-side.component.html',
  styleUrls: ['./crud-article-side.component.css']
})
export class CrudArticleSideComponent implements OnInit {
