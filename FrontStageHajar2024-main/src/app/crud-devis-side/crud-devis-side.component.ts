...
@Component({
  selector: 'app-crud-devis-side',
  templateUrl: './crud-devis-side.component.html',
  styleUrls: ['./crud-devis-side.component.css']
})
export class CrudDevisSideComponent implements OnInit {
