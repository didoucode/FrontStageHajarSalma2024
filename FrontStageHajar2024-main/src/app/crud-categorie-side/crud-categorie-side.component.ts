...
@Component({
  selector: 'app-crud-categorie-side',
  templateUrl: './crud-categorie-side.component.html',
  styleUrls: ['./crud-categorie-side.component.css']
})
export class CrudCategorieSideComponent implements OnInit {
