...
@Component({
  selector: 'app-add-prospect-with-sidebar',
  templateUrl: './add-prospect-with-sidebar.component.html',
  styleUrls: ['./add-prospect-with-sidebar.component.css']
})
export class AddProspectWithSidebarComponent {
