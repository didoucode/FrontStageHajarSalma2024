...
@Component({
  selector: 'app-success-modal-edit-ass',
  templateUrl: './success-modal-edit-ass.component.html',
  styleUrls: ['./success-modal-edit-ass.component.css']
})
export class SuccessModalEditAssComponent  {
