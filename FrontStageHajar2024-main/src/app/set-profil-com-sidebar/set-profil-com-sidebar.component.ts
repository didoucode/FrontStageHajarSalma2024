...
@Component({
  selector: 'app-set-profil-com-sidebar',
  templateUrl: './set-profil-com-sidebar.component.html',
  styleUrls: ['./set-profil-com-sidebar.component.css']
})
export class SetProfilComSidebarComponent  {
